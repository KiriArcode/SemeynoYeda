...
Компактный тег с фоновой подложкой. Основные типы (полный список и стили — см. [STYLEGUIDE.md](STYLEGUIDE.md), таблица тегов, и [src/data/schema.ts](src/data/schema.ts) тип DietTag):
...
| batch-cooking | `#1A1A28` | `#B388FF` | `#2D2D40` |
| rich-feel | `#280D1A` | `#FF6B9D` | `#401A2D` |
| blanch-before-freeze | как freezable | `#00E5FF` | `#1A3040` |
