...
- React Router с lazy-загрузкой страниц, Vercel (base: '/')
...
| `/recipes` | RecipesPage | Каталог 57 рецептов: поиск, фильтр по категориям, тег из query (`?tag=prep-day`), бейджи suitableFor и теги на карточках |
...
**Seed данные:**
- 57 seed-рецептов: соусы, котлеты, фрикадельки, суфле, пюре, крупы, завтраки, полдники
